...
Open data is at the heart of data.world, and as such we want to make it as easy as possible to use data.world data in your environment of choice so you can do your work easier and solve real problems faster. Which brings us to this tutorial where you’ll learn how to work with data.world using Python.

We’ll walk through the different ways to connect to data.world and the basic functionality in our Python SDK. Let’s start with the basics of loading the `datadotworld` library and pulling in a dataset to kick things off….
